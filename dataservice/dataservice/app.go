...
//sqlStatement := `SELECT * FROM payer ;`
//	return fmt.Sprintf("SELECT id, payer_id, payer_name, parent_id FROM payer WHERE payer_name ='%s';", payerName)
//return fmt.Sprintf(sqlStatement)
//}

/*

func buildSql3(sqltype string, name string, id int) string {
	switch sqltype {
	case "PayerName":
